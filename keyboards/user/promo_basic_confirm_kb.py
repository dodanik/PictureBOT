...
async def create_promo_code_basic_confirm_kb(lang, langKb):
    # Создаем клавиатуру
    ...
    promo_code_confirm.button(text=texts['add_promo_code'], callback_data=f"basic_dwnl_pr_{lang}")
    promo_code_confirm.button(text=texts['without_promo_code'], callback_data=f"basic_dwnl_no_{lang}")
